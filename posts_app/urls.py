...
from . import views
from .views import ListPosts, PostDetailView, CreatePostView, ListPostsBack, PostsData, PostUpdateView, PostDeleteView
...
urlpatterns = [
    ...
    path('posts/data/', PostsData.as_view(), name='posts_data'),
